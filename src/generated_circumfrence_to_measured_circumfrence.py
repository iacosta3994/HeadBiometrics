...
# how is the length shorter, and the breadth shorter result in a larger measured circumference.
person3 = [54.3, 15.0, 11.2]
...
list_of_heads = [head_1, head_2,  head_4, head_5, head_6, head_7,
...
def generated_circumference_minus_measured_diffrence(measured_circumfrence, length, breadth, mean_head_percentage):
    generated_circumference = generated_circumference_x_mean_head_percentage(
        measured_circumfrence, length, breadth, mean_head_percentage)
...
list_of_tests = [test1, test2,  test4, test5, test6, test7,
...
print("This is the mean between the difference of the measured circumference and the generated circumference: {} inches || {} mm".format(
    mean_diffrence_box_measured, mean_diffrence_generated_cm*10))
print("This would determine that the generated circumference is off by : +/- {} inches || +/- {} mm".format(
    mean_diffrence_box_measured, mean_diffrence_generated_cm*10))
